             ...
             <table>
                 ...
                 <tr>
                    <td id="esto" runat="server" colspan="3" style="text-align:center" class="auto-style5">
                        ...
                        <asp:GridView ID="Grpaseadores" runat="server" AutoGenerateColumns="false" CellPadding="4" ForeColor="Brown" GridLines="none" OnRowCommand="grpa_Comand" OnRowCreated="Gr_created"  >
